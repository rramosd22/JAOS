...
public class ventanaBusquedaFacturas extends javax.swing.JFrame {
...
//    public int registrosIniciales, registrosTotales, registrosInicialPag, registrosFinalPag;
    public VentanaAnularFactura venafact;
    private int x, y;
    List<Map<String, String>> list_consul;
    public int ban = 0;

    public ventanaBusquedaFacturas() {
        initComponents();
        Utilidades.EstablecerIcono(this);
        modelo = new DefaultTableModel();
        this.setLocationRelativeTo(null);

        String[] nombreColumnas = new String[5];
        nombreColumnas = new String[]{"Tipo e ID", "Nombre", "Nro Factura", "Fecha", "Valor"};
        int filas = 0;

        cargarTabla(nombreColumnas, filas);
    }

    public ventanaBusquedaFacturas(VentanaAnularFactura venaf) {
        initComponents();
        Utilidades.EstablecerIcono(this);
    ...
    private void LlenarListaDatos() {
        SQL = "SELECT \n"
                + "pfk_paciente TYPYDOC,\n"
                + "CONCAT(TRIM(CONCAT(primer_nombre,' ',segundo_nombre)),' ',TRIM(CONCAT(primer_apellido,' ',segundo_apellido))) NOMBRE,\n"
                + "numero NROFACTURA,\n"
                + "DATE_FORMAT(fecha, '%d/%m/%Y') FECHA,\n"
                + "FORMAT(valor_fact,0) VALOR\n"
                + "FROM\n"
                + "facturas,\n"
                + "personas\n"
                + "WHERE\n"
    ...
    private void initComponents() {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 168, 501, 220));
        ...
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 0, 30, 30));
        ...
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 0, 30, 30));
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 530, 31));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventanaBusquedaFacturas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventanaBusquedaFacturas(null).setVisible(true);
            }
        });
    }
    ...
    private void selectRow() {
        ...
        if (filaSeleccionada > -1) {
            ...
            venafact.setAanulatFactura(modAux, filaSeleccionada);
        } else {
            venafact.EstadoBotones(0);
        }
